...
<div class="tabs">
 <button class="tab" data-t="adopt">Adoption map</button><button class="tab" data-t="proc">Procurement</button>
 <button class="tab on" data-t="time">Timeline</button><button class="tab" data-t="invest">Investment</button>
 <button class="tab" data-t="lit">Litigation</button><button class="tab" data-t="cap">Capabilities</button></div>
<div class="bar">
 <span id="domWrap">Domain: <select id="domSel"><option value="">all</option></select></span>
