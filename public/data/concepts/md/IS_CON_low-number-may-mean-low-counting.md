---
id: IS-CON-LOW-NUMBER-MAY-MEAN-LOW-COUNTING
title: Concept — The numbers under the numbers
collection: concepts
doc_type: concept
basis: documented
origin: ai
...
- [How much the numbers can be trusted](/data)

*The data-quality register lists every mechanism with its source.*
