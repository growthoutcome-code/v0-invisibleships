---
id: IS-CON-EVERYONE-AROUND-A-TARGET
title: Concept — What happens to everyone around a target?
collection: concepts
doc_type: concept
basis: documented
origin: ai
...
---
# What happens to everyone around a target?
...
- [Stingray tracking devices — ACLU](https://www.aclu.org/issues/privacy-technology/surveillance-technologies/stingray-tracking-devices)
- [Uncovering the FBI's surveillance tech secrecy agreements — ACLU](https://www.aclu.org/news/privacy-technology/surreal-stingray-secrecy-uncovering-the-fbis-surveillance-tech-secrecy-agreements)
- [What are children subject to?](/concepts#what-children-are-subject-to)
- [Accountability isn't wired to deployment, even in the schema](/concepts#accountability-not-wired)
