...
export const CORPUS_SUMMARY = {
  ...
  { key: "concepts", label: "Concepts", blurb: "The archive's arguments, each labelled with a basis, an origin, a theme and the readers it was written for.", markdown: 40, data: 2 },
